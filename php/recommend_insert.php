...
<head>
    ...
    <link rel="stylesheet" href="../css/recommend_insert.css" />
    <title></title>
</head>
    ...
    <div id="wrapper">
        ...
        <div id="main">
            <div class="inner">
                ...
                <section id="banner">
                    <div class="content">
                      <form id="insert-form" action="recommend_insert_process.php" method="post" role="form" style="display: block;">
                        ...
                        <input type="url" id="link" name="link" placeholder="Youtube 링크" value="">
                        <input type="text" id="content" name="content" placeholder="짧은 소개글" value="">
                        <div id="btn-group">
                          <input type="submit" name="register" id="register" value="등록">
                          <input type="button" id="cancel" onclick="location.replace('recommend_board.php');" value="취소">
                        </div>
                      </form>
                    </div>
                </section>
